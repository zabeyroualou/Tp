...
public class Categories extends TableImpl<CategoriesRecord> {
    ...
    /**
     * The column <code>public.categories.code</code>.
     */
    public final TableField<CategoriesRecord, String> CODE = createField(DSL.name("code"), SQLDataType.VARCHAR(10).nullable(false), this, "");

    /**
     * The column <code>public.categories.nom</code>.
     */
    public final TableField<CategoriesRecord, String> NOM = createField(DSL.name("nom"), SQLDataType.VARCHAR(225).nullable(false), this, "");
